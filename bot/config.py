...
# Per-file rotation: keep only the N most-recent backup copies of each
# persisted JSON. 0 disables backups entirely (useful for busy files like
# channel_logs).
...
# =========================
# Tenor (used by /gif, /hug, /pat etc). The previous fallback was a hard-coded
# public key that had been committed to source control — rotate it and set
# TENOR_API_KEY in your environment. Commands that need a gif will degrade
...
# Confessions
# =========================
CONFESSION_CHANNEL_ID = _env_int("CONFESSION_CHANNEL_ID", 1492170739955138630)
CONFESSION_LOG_USER_ID = _env_int("CONFESSION_LOG_USER_ID", 734468552903360594)
